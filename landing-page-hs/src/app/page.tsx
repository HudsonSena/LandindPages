  ...
  return (
    <div className='p-4 flex flex-col text-center'>
      ...
      <main id="links" className='flex flex-col gap-5 text-center w-[20rem] m-auto'>
        <h1 className='rounded-2xl bg-muted px-4 py-1.5'><a href="">Site Pessoal</a></h1>
      ...
      <footer id="create" className='space-y-6 py-8 md:py-12 lg:pb-32 '><p>Landing Page criada por <span>Hudson Sena</span>, com NextJs e TailwindCss</p></footer>
    </div>
  )
}
